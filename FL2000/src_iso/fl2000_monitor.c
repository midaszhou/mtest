...
//+++++-----ISO enable BIA  !!!! NO EFFECT 
//	fl2000_reg_bit_set(dev_ctx, REG_OFFSET_803C, 22);
//-------------end of ISO


//+++++----ISO suspend ISO relevant Reg clearing
...
//+++++-----ISO use fl2000_reg_bit_clear(dev_ctx, REG_OFFSET_803C, 27) for END of FRAME
...
//---------------------------end of ISO
	...
	if (dev_ctx->vr_params.use_compression) {
		// +++++COMP printk Set bit 24, Enable compression mode.
		printk("======== monitor: ret reg to enbale compression =======\n");
	...
	//
//+++++-----ISO suspend clearing Iso Registers !!! seems useless codes !!!!!
...
//+++++-----ISO suspend fl2000_reg_bit_set(dev_ctx, REG_OFFSET_0070, 13)!!! seems useless codes !!!!!
	fl2000_reg_bit_set(dev_ctx, REG_OFFSET_0070, 13);
//	fl2000_reg_bit_clear(dev_ctx, REG_OFFSET_0070, 13); //--clear this will get blured image
//-----------------------------ebd if USI
