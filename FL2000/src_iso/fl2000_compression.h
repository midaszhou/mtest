...
//+++++COMP define  COMPRESSION_MASK_INDEX_MINIMUM          ( COMPRESSION_MASK_12_BIT_INDEX )
//#define COMPRESSION_MASK_INDEX_MINIMUM          ( COMPRESSION_MASK_23_BIT_INDEX )
#define COMPRESSION_MASK_INDEX_MINIMUM          ( COMPRESSION_MASK_15_BIT_INDEX )
...
//+++++----COMP adjst MASK_04_BIT_VALUE
#define COMPRESSION_MASK_04_BIT_VALUE           ( 0xFF7F3F7F )
//#define COMPRESSION_MASK_04_BIT_VALUE           ( 0xFFFF8C63)//( 0xFFFF8C63 )
