...
fl2000_comp_get_current_mask_value(struct dev_ctx * dev_ctx)
{
	...
	case COMPRESSION_MASK_15_BIT_INDEX:
		...
		break;
//+++++COMP add case COMPRESSION_MASK_13 & 14_BIT_INDEX
	case COMPRESSION_MASK_14_BIT_INDEX:
		mask = COMPRESSION_MASK_14_BIT_VALUE;
		break;
	case COMPRESSION_MASK_13_BIT_INDEX:
		mask = COMPRESSION_MASK_13_BIT_VALUE;
		break;
...
//+++++COMP printk info...
	printk("====== start: ooselyColorMaskRGB = fl2000_comp_get_current_mask_value(dev_ctx) ... =========\n");
	looselyColorMaskRGB = fl2000_comp_get_current_mask_value(dev_ctx);
	//looselyColorMaskRGB = COMPRESSION_MASK_15_BIT_VALUE;
	printk("====== end: ooselyColorMaskRGB = fl2000_comp_get_current_mask_value(dev_ctx)==0x%lx  ... =========\n",looselyColorMaskRGB);
//-----------end of COMP
